...
SECRET_KEY = '^r0p*hied#(18rr$#6p#^&(&1fpo_97h=rk^hzn$j$mw*j+2@c'
...
STATIC_URL = '/static/proyectowebapp/'
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join (BASE_DIR ,'media')


#creamos la configuracion de el acceso al correo electronico en este caso  gmail
